...
describe("Login Component", () => {
  ...
  // Test if logIn is called with email and password as params
  it("calls logIn prop with correct credentials when form is submitted", async () => {
    cleanup()
    ...
    expect(logInMock).toHaveBeenCalledWith("test@example.com", "mypassword123");
  });
});
