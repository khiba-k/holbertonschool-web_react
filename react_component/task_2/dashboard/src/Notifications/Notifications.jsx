          ...
          <div>
            ...
            <ul>
              {this.props.notifications.length > 0 ? ((this.props.notifications).map(notification => {
                return (
                  <NotificationItem key={notification.id} id={notification.id} type={notification.type} html={notification.html} value={notification.value} markAsRead={this.markAsRead} />
                )
              })) : <p>No new notification for now</p>}
            </ul>
          </div>
